...
public class Localisation {
    ...
    public Localisation(Cursor cursor) {
        this(cursor.getString(0), (cursor.isNull(1) ? null : cursor.getDouble(1)), (cursor.isNull(2) ? null : cursor.getDouble(2)), (cursor.isNull(3) ? null : cursor.getString(3)), cursor.getString(4));
    }
